...
exports.setup = exports.postResponse = exports.postRequest = exports.postEvent = exports.postMessage = undefined;
...
var onResponse = function onResponse(_ref) {
  var data = _ref.data,
      id = _ref.id,
      ok = _ref.ok;
...
var postMessage = exports.postMessage = function postMessage() {
  var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  window.postMessage(JSON.stringify(payload));
};

var postEvent = exports.postEvent = function postEvent(_ref2) {
  var name = _ref2.name,
      data = _ref2.data;
...
var postRequest = exports.postRequest = function postRequest(_ref3) {
  var name = _ref3.name,
      data = _ref3.data;
...
var postResponse = exports.postResponse = function postResponse(_ref4) {
  var name = _ref4.name,
      data = _ref4.data,
      id = _ref4.id;
